...
export type Site = { id: number; name: string; province: string; city: string; county: string; address: string; summary: string; mapKeyword: string; recommendedSeason: string; visitorService?: { scene: string; name: string; phone: string; businessHours?: string } };
...
export type Homestay = { id: number; name: string; type: string; summary: string; capacity: string; price: string; coverUrl: string; consultationPhone?: string };
...
export type Product = { id: number; name: string; category: string; season: string; summary: string; coverUrl: string; startingPrice: number; farmerName: string; farmerId: number };
